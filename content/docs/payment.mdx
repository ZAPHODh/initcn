...
<Cards>
  ...
  <Card title="Drizzle" href="/docs/payment/drizzle">
    Complete guide for using payment-stripe with Drizzle ORM
  </Card>
</Cards>
...
<Cards>
  ...
  <Card title="Drizzle Schema" href="/docs/payment/drizzle#database-schema">
...
- [Drizzle Guide](/docs/payment/drizzle) - Installation, setup, usage, and API reference
