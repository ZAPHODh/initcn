...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
  ```bash
  npx shadcn@latest add https://initcn.vercel.app/r/auth-otp-drizzle.json
  ```
  </Tab>

  <Tab value="pnpm">
  ```bash
  pnpm dlx shadcn@latest add https://initcn.vercel.app/r/auth-otp-drizzle.json
  ```
  </Tab>

  <Tab value="yarn">
  ```bash
  yarn dlx shadcn@latest add https://initcn.vercel.app/r/auth-otp-drizzle.json
  ```
  </Tab>

  <Tab value="bun">
  ```bash
  bunx --bun shadcn@latest add https://initcn.vercel.app/r/auth-otp-drizzle.json
  ```
  </Tab>
</Tabs>
...
Troubleshooting is the same as the Prisma variant. See the [Prisma guide troubleshooting section](/docs/auth/prisma#troubleshooting) for help with:
