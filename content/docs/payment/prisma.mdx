---
title: Stripe with Prisma
description: Set up Stripe subscription management with Prisma ORM
---

# Stripe Subscriptions with Prisma

Complete guide for integrating Stripe subscription management using Prisma ORM.

## Installation

Install both the shared utilities and the Prisma implementation:

```bash
npx shadcn@latest add https://initcn.vercel.app/r/payment-stripe-shared.json
npx shadcn@latest add https://initcn.vercel.app/r/payment-stripe-prisma.json
```
